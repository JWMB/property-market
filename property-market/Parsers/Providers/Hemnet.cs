...
namespace Parsers.Providers
{
    public class Hemnet : IPropertyDataProvider, IPropertyListingSearchProvider, IPropertyListingProvider
    {
        ...
        public async Task<IPropertyListingSearchProvider.FetchResult> FetchPropertySearchResults(PropertyFilter? filter = null, int skip = 0, int take = 100)
        {
            ...
            return new IPropertyListingSearchProvider.FetchResult { Source = curl.Uri, Content = content };
        }
        ...
        public async Task<IPropertyListingProvider.FetchResult> FetchPropertyListingResult(string objectId)
        {
            ...
            return new IPropertyListingProvider.FetchResult { Listing = ParsePropertyListing(curl.Uri, content), RawResult = content };
        }
